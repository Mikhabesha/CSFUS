...
namespace CSFUF.Controllers
{
    public class AccountController : Controller
    {
       ...
       CSFUFDB1 db = new CSFUFDB1();
        ...
        {
            var regList = from s in db.RegionsDbs select s.RegionName;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { UserName = model.UserName, Region = model.Region };
        ...
        [AllowAnonymous]
        public ActionResult RegisterForRegion()
        {
            var regList = from s in db.RegionsDbs select s.RegionName;
            ViewBag.Regions = regList;
            return View();
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult> RegisterForRegion(RegisterViewModelForRegion model)
        {
            if (ModelState.IsValid)
            {
